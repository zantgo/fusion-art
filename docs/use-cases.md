...
> **Nota para implementación:** Este flujo debe reflejarse en el ViewModel mediante eventos y estados. Se recomienda usar un `sealed class FusionEvent` para navegación y mensajes.
